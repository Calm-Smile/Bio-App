...
class _OverviewPageState extends State<OverviewPage>
  ...
  void _listener() {
    ...
    final double position = _scrollController.position.pixels.isNegative
        ? 0.0
        : _scrollController.position.pixels;

    _scrollPercentage = position / maxScrollExtent;
    ...
    final int stoppedIndex = (scolledHeight / heightOfBox)
        .ceil()
        .clamp(1, animalNames.length)
        .toInt();
    _currentIndex = stoppedIndex;
